[![Build Status](https://travis-ci.com/digitaldomain/DiscreteDifferentialGeometry.jl.svg?branch=master)](https://travis-ci.com/digitaldomain/DiscreteDifferentialGeometry.jl)
